...
module.exports = function(homebridge) {
    ...
    homebridge.registerAccessory("homebridge-pilight-somfy-blinds", "Pilight-Somfy-Blinds", PilightSomfyBlindsAccessory);
}

function PilightSomfyBlindsAccessory(log, config) {
    // global vars
    this.log = log;
...
PilightSomfyBlindsAccessory.prototype.getCurrentPosition = function(callback) {
    this.log("Requested CurrentPosition: %s", this.lastPosition);
    callback(null, this.lastPosition);
}

PilightSomfyBlindsAccessory.prototype.getPositionState = function(callback) {
    this.log("Requested PositionState: %s", this.currentPositionState);
    callback(null, this.currentPositionState);
}

PilightSomfyBlindsAccessory.prototype.getTargetPosition = function(callback) {
    this.log("Requested TargetPosition: %s", this.currentTargetPosition);
    callback(null, this.currentTargetPosition);
}

PilightSomfyBlindsAccessory.prototype.setTargetPosition = function(pos, callback) {
...
PilightSomfyBlindsAccessory.prototype.httpRequest = function(url, method, callback) {
  this.log("TODO: trigger pilight communication here")
}

PilightSomfyBlindsAccessory.prototype.getServices = function() {
  return [this.service];
}
